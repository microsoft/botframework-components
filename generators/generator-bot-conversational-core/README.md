...
> Yeoman generator for creating an Adaptive bot built on the Azure Bot Framework using the Conversational Core template.
...
```bash
yo @microsoft/bot-conversational-core '{BOT_NAME}'
```
