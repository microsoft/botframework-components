...
namespace PointOfInterestSkill.Adapters
{
    public class DefaultAdapter : BotFrameworkHttpAdapter
    {
            ...
            : base(credentialProvider, authConfig, channelProvider, logger: logger)
        {
            ...
            _templateManager = templateEngine ?? throw new ArgumentNullException(nameof(templateEngine));
        ...
        private async Task SendErrorMessageAsync(ITurnContext turnContext, Exception exception)
        {
            try
            {
                ...
                await turnContext.SendActivityAsync(_templateManager.GenerateActivity(POISharedResponses.PointOfInterestErrorMessage));
