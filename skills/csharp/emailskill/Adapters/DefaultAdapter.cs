...
namespace EmailSkill.Adapters
{
    public class DefaultAdapter : BotFrameworkHttpAdapter
    {
            ...
            : base(credentialProvider, authConfig, channelProvider, logger: logger)
        {
            ...
            _templateEngine = templateManager ?? throw new ArgumentNullException(nameof(templateManager));
        ...
        private async Task SendErrorMessageAsync(ITurnContext turnContext, Exception exception)
        {
            try
            {
                ...
                await turnContext.SendActivityAsync(_templateEngine.GenerateActivityForLocale(EmailSharedResponses.EmailErrorMessage));
