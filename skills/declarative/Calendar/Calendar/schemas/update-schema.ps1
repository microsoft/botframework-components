...
<<<<<<< HEAD:skills/declarative/calendarSkill/calendarskill/schemas/update-schema.ps1
...
>>>>>>> d40c144c... Update calendar dev and test project (#854):skills/declarative/Calendar/Calendar/schemas/update-schema.ps1
