...
namespace Microsoft.Bot.Solutions.Extensions.Actions
{
    ...
    /// </summary>
    public class CustomGotoAction : Dialog
    {
        [JsonProperty("$kind")]
        public const string Kind = "Microsoft.Bot.Solutions.CustomGotoAction";

        public CustomGotoAction(string actionId = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
        {
