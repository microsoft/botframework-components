...
bf dialog:merge "*.schema" "!sdk-backup.schema" "*.uischema" "!sdk-backup.uischema" "!sdk.override.uischema" "../runtime/$runtime/*.csproj" "..\..\..\..\..\packages\Graph\Microsoft.Bot.Components.Graph.csproj" -o $SCHEMA_FILE
