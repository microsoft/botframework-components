...
{
    class DeleteEvent : Dialog
    {
        [JsonProperty("$kind")]
        public const string DeclarativeType = "Microsoft.Graph.Calendar.DeleteEvent";
        ...
        public override async Task<DialogTurnResult> BeginDialogAsync(DialogContext dc, object options = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                await graphClient.Me.Events[meetingId].Request().DeleteAsync();
            }
            ...
            await dc.Context.TraceActivityAsync(nameof(DeleteEvent), null, valueType: DeclarativeType, label: this.Id).ConfigureAwait(false);
