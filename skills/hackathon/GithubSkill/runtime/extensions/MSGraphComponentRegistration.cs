...
namespace Microsoft.Bot.Solutions.Extensions
{
    public class MSGraphComponentRegistration : ComponentRegistration, IComponentDeclarativeTypes
    {
        public IEnumerable<DeclarativeType> GetDeclarativeTypes(ResourceExplorer resourceExplorer)
        {
            ...
            //yield return new DeclarativeType<UpdateWorkBookData>(UpdateWorkBookData.DeclarativeType);
            ...
            yield return new DeclarativeType<GetIssuesPerDay>(GetIssuesPerDay.DeclarativeType);
