        ...
        public override async Task<DialogTurnResult> BeginDialogAsync(DialogContext dc, object options = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                if (searchResults.Count() > 0)
                {
                    ...
                    var workbookRange = await GraphHelper.GetRange(graphClient, id, "Sheet1", "A1:B3", sessionInfo);
                    ...
                    var workbookRangeUpdated = await GraphHelper.PatchRange(graphClient, id, "Sheet1", "A1:B3", workbookRange, sessionInfo);
