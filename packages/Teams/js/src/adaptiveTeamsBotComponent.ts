        ...
        declarativeTypes.concat({
          getDeclarativeTypes() {
            return [
              ...
              {
                kind: SendAppBasedLinkQueryResponse.$kind,
                type: SendAppBasedLinkQueryResponse,
              },
              { kind: SendMEActionResponse.$kind, type: SendMEActionResponse },
              {
                kind: SendMEAttachmentsResponse.$kind,
                type: SendMEAttachmentsResponse,
              },
              { kind: SendMEAuthResponse.$kind, type: SendMEAuthResponse },
              {
                kind: SendMEBotMessagePreviewResponse.$kind,
                type: SendMEBotMessagePreviewResponse,
              },
              {
                kind: SendMEConfigQuerySettingUrlResponse.$kind,
                type: SendMEConfigQuerySettingUrlResponse,
              },
              {
                kind: SendMEMessageResponse.$kind,
                type: SendMEMessageResponse,
              },
              {
                kind: SendMESelectItemResponse.$kind,
                type: SendMESelectItemResponse,
              },
              {
                kind: SendMessageToTeamsChannel.$kind,
                type: SendMessageToTeamsChannel,
              },
              { kind: SendTabAuthResponse.$kind, type: SendTabAuthResponse },
              { kind: SendTabCardResponse.$kind, type: SendTabCardResponse },
              {
                kind: SendTaskModuleCardResponse.$kind,
                type: SendTaskModuleCardResponse,
              },
              {
                kind: SendTaskModuleMessageResponse.$kind,
                type: SendTaskModuleMessageResponse,
              },
              {
                kind: SendTaskModuleUrlResponse.$kind,
                type: SendTaskModuleUrlResponse,
              },

              // Conditions
              {
                kind: OnTeamsAppBasedLinkQuery.$kind,
                type: OnTeamsAppBasedLinkQuery,
              },
              { kind: OnTeamsCardAction.$kind, type: OnTeamsCardAction },
              {
                kind: OnTeamsChannelCreated.$kind,
                type: OnTeamsChannelCreated,
              },
              {
                kind: OnTeamsChannelDeleted.$kind,
                type: OnTeamsChannelDeleted,
              },
              {
                kind: OnTeamsChannelRenamed.$kind,
                type: OnTeamsChannelRenamed,
              },
              {
                kind: OnTeamsChannelRestored.$kind,
              ...
              {
                kind: OnTeamsMEBotMessagePreviewSend.$kind,
                type: OnTeamsMEBotMessagePreviewSend,
              },
              {
                kind: OnTeamsMECardButtonClicked.$kind,
                type: OnTeamsMECardButtonClicked,
              },
              {
                kind: OnTeamsMEConfigSetting.$kind,
                type: OnTeamsMEConfigSetting,
              },
              {
                kind: OnTeamsMEConfigQuerySettingUrl.$kind,
                type: OnTeamsMEConfigQuerySettingUrl,
              },
              ...
              {
                kind: OnTeamsO365ConnectorCardAction.$kind,
                type: OnTeamsO365ConnectorCardAction,
              },
              { kind: OnTeamsTabFetch.$kind, type: OnTeamsTabFetch },
              { kind: OnTeamsTabSubmit.$kind, type: OnTeamsTabSubmit },
              {
                kind: OnTeamsTaskModuleFetch.$kind,
                type: OnTeamsTaskModuleFetch,
              },
              {
                kind: OnTeamsTaskModuleSubmit.$kind,
                type: OnTeamsTaskModuleSubmit,
              },
              { kind: OnTeamsTeamArchived.$kind, type: OnTeamsTeamArchived },
              { kind: OnTeamsTeamDeleted.$kind, type: OnTeamsTeamDeleted },
              {
                kind: OnTeamsTeamHardDeleted.$kind,
                type: OnTeamsTeamHardDeleted,
              },
              { kind: OnTeamsTeamRenamed.$kind, type: OnTeamsTeamRenamed },
              { kind: OnTeamsTeamRestored.$kind, type: OnTeamsTeamRestored },
              {
                kind: OnTeamsTeamUnarchived.$kind,
                type: OnTeamsTeamUnarchived,
              },
            ];
          },
        })
