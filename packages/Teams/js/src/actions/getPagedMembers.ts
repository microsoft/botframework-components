 ...
 */
export class GetPagedMembers
  extends Dialog
  implements GetPagedMembersConfiguration {
  /**
   * Class identifier.
   */
  ...
  public getConverter(
    property: keyof GetPagedMembersConfiguration
  ...
  public async beginDialog(
    ...
    if (dc.context.activity.channelId !== Channels.Msteams) {
      throw new Error(
        `${GetPagedMembers.$kind} works only on the Teams channel.`
      );
    }
