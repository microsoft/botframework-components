...
export interface SendMEMessageResponseConfiguration
...
export class SendMEMessageResponse
  ...
  public getConverter(
    property: keyof SendMEMessageResponseConfiguration
  ...
  public async beginDialog(
    ...
    if (!message) {
      throw new Error(
        `A Message is required for ${SendMEMessageResponse.$kind}.`
      );
    }
