 ...
 */
export class GetTeamChannels
  extends Dialog
  implements GetTeamChannelsConfiguration {
  /**
   * Class identifier.
   */
  ...
  public getConverter(
    property: keyof GetTeamChannelsConfiguration
  ...
  public async beginDialog(
    ...
    if (dc.context.activity.channelId !== Channels.Msteams) {
      throw new Error(
        `${GetTeamChannels.$kind} works only on the Teams channel.`
      );
    }
