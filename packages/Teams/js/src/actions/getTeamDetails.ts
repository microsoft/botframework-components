 ...
 */
export class GetTeamDetails extends Dialog implements GetTeamDetailsConfiguration {
    /**
     * Class identifier.
     */
    ...
    public getConverter(property: keyof GetTeamDetailsConfiguration): Converter | ConverterFactory {
        switch (property) {
            case 'disabled':
