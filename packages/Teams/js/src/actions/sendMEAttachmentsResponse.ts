...
export interface SendMEAttachmentsResponseConfiguration
...
export class SendMEAttachmentsResponse
   ...
   * list
   */
  public attachmentLayout: EnumExpression<AttachmentLayout> = new EnumExpression(
    'list'
  );

  public getConverter(
    property: keyof SendMEAttachmentsResponseConfiguration
  ...
  public async beginDialog(
    ...
    if (!activity?.attachments?.length) {
      throw new Error(
        `Missing attachments in ${SendMEAttachmentsResponse.$kind}.`
      );
    }
